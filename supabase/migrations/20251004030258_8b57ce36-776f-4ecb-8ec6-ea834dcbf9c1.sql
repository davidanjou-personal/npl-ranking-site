...
CREATE INDEX idx_player_rankings_player_category ON public.player_rankings(player_id, category);
CREATE INDEX idx_player_rankings_category_rank ON public.player_rankings(category, rank);